...
'''
Compute the Mean Fréchet distance for all models.
This script download the pretrained models available on the HuggingFace Hub.
    ...
    for beta in betas:
        for rescale in rescales:
            ...
            for seed in range(4):
                ...
                run = wandb.init(entity='your_entity', # fill your Wandb user name or comment this out
                                                       # and pass None instead of run.path in the compute_mfd function
